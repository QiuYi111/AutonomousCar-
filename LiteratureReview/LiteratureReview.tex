...
\multirow{2}{*}{邱璟祎} & 循迹算法   & \multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}车体设计，夹取设计\\ 避障算法，其他驱动\end{tabular}} \\ \cline{2-2}
                     & 蓝牙模块   &                                                                                \\ \hline
\multirow{3}{*}{周俊豪} & 避障算法   & \multirow{3}{*}{\begin{tabular}[c]{@{}c@{}}夹取设计，循迹算法\\ 避障算法，其他驱动\end{tabular}} \\ \cline{2-2}
                     & 车体设计   &                                                                                \\ \cline{2-2}
                     & IMU    &                                                                                \\ \hline
\multirow{2}{*}{张峻瑜} & 夹取设计   & \multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}车体设计，循迹算法\\ 避障算法，其他驱动\end{tabular}} \\ \cline{2-2}
                     & 电机驱动   &                                                                                \\ \hline
\end{tabular}%
}
\caption{人员分工表}
